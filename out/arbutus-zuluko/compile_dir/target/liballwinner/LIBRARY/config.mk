...
CONFIG_CEDARX_PATH = /home/celema/workspace/sdk/Vego_PI_zuluko_sdk/v1b6/Vego-SDK-arbutus-zuluko.Linux-x86_64/out/arbutus-zuluko/compile_dir/target/liballwinner
...
############################## configuration. ###############################
#############################################################################
CONFIG_CC = $(OPTION_CC_LINUX_MUSLGNUEABI)
CONFIG_OS = $(OPTION_OS_LINUX)
CONFIG_PRODUCT = $(OPTION_PRODUCT_TVBOX)
CONFIG_CHIP = $(OPTION_CHIP_R16)
